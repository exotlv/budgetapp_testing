            ...
            put("default", new Properties() {
                {
                    ...
                    //application URL's
                    setProperty(ApplicationProperty.APP_URL.name, "http://localhost:8000");
                    ...
                    setProperty(ApplicationProperty.TEST_DATA.name, "Test");
                    setProperty(ApplicationProperty.VALUE_DATA.name, "100");
